...
[CustomEditor(typeof(RFX1_EffectSettings))]
public class RFX1_EffectSettingsInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        var script = (RFX1_EffectSettings)target;
        ...
        if (script.GetComponentInChildren<RFX1_Decal>() != null && isMobilePlatfrom)
        ...
        if (script.GetComponentInChildren<RFX1_TransformMotion>() != null)
        {
            EditorGUILayout.Space();
            EditorGUILayout.BeginVertical();
